...
var Truck = {
  ...
  start: function start() {
    console.log("Brmmmmm ".concat(this.name));
  }
};
var Bird = {
  name: "Sparrow",
  fly: function fly() {
    console.log("Flyyyyiinnn ".concat(this.name));
  }
};
...
var BoundTruck = Bird.fly.bind(Truck);
BoundTruck();
